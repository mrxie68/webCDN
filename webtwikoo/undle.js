...
!function(t, e) {
    ...
    S.prototype.emit = function(t) {
        ...
        if (!e || !e.length)
            return this._clearOnEmit = !1,
            this;
        var i, s = this._queue, n = s.length, o = arguments.length - 1;
        o > 3 && ((i = []).push.apply(i, arguments),
        i.shift()),
        s.push.apply(s, e),
        ...
        for (var r = n, h = s.length; r < h; r++)
            if (0 === o ? s[r]() : 1 === o ? s[r](arguments[1]) : 2 === o ? s[r](arguments[1], arguments[2]) : 3 === o ? s[r](arguments[1], arguments[2], arguments[3]) : s[r].apply(null, i),
            !this._events)
                return this;
    ...
    D.prototype.destroy = function() {
        w && (this._dragger.off("start", this._onStart),
    ...
    X._inputEvents = g ? X._touchEvents : v ? X._pointerEvents : y ? X._msPointerEvents : X._mouseEvents,
    X._emitter = new S,
    X._emitterEvents = {
        start: "start",
        move: "move",
    ...
    X._activateInstance = function(t) {
        X._activeInstances.indexOf(t) > -1 || (X._activeInstances.push(t),
    ...
    X._deactivateInstance = function(t) {
        ...
        -1 !== e && (X._activeInstances.splice(e, 1),
    ...
    X._bindListeners = function() {
        ...
        X._inputEvents.cancel && window.addEventListener(X._inputEvents.cancel, X._onCancel, C)
    }
    ,
    X._unbindListeners = function() {
        ...
        X._inputEvents.cancel && window.removeEventListener(X._inputEvents.cancel, X._onCancel, C)
    }
    ,
    ...
    X.prototype._onStart = function(t) {
        if (!this._isDestroyed && null === this._pointerId && (this._pointerId = X._getEventPointerId(t),
    ...
    X.prototype._onCancel = function(t) {
        this._getTrackedTouch(t) && (this._emit(X._emitterEvents.cancel, t),
        this._reset())
    }
    ,
    X.prototype._onEnd = function(t) {
        this._getTrackedTouch(t) && (this._emit(X._emitterEvents.end, t),
        this._reset())
    }
    ,
    ...
    X.prototype.setTouchAction = function(t) {
        this._touchAction = t,
        P && (this._cssProps[P] = "",
        this._element.style[P] = t),
        g && (this._element.removeEventListener(X._touchEvents.start, X._preventDefault, !0),
        (this._element.style[P] !== t || R && I) && this._element.addEventListener(X._touchEvents.start, X._preventDefault, !0))
    }
    ,
    ...
    q.prototype._step = function(t) {
        var e, i, s, n, o, r, h = this._lanes, a = this._stepQueue, _ = this._stepCallbacks;
    ...
    var pt, mt = document.documentElement, gt = document.body, vt = {
        value: 0,
        offset: 0
    };
    function yt(t) {
    ...
    function xt(t, e, i, s) {
        return vt.value = Math.min(s / 2, t),
    ...
    function(t) {
        var e = this.item
          , i = Et(e).speed;
        return dt(i) ? (pt.direction = this.direction,
    ...
    Lt.prototype.computeScrollValues = function() {
        this.scrollLeft = this.requestX ? this.requestX.value : St(this.element),
        this.scrollTop = this.requestY ? this.requestY.value : wt(this.element)
    }
    ,
    ...
    function Pt() {
        ...
        this._requestPool = new Rt((function() {
            return new kt
        }
        ),(function(t) {
            t.reset()
    ...
    Pt.smoothSpeed = function(t, e, i) {
        return function(s, n, o) {
            ...
            var a = o.speed
              , _ = r;
            return a === r ? _ : a < r ? (_ = a + e * (o.deltaTime / 1e3),
    ...
    Pt.prototype._writeTick = function() {
        ...
        lt(this._readTick, this._writeTick))
    }
    ,
    ...
    Pt.prototype._checkItemOverlap = function(t, e, i) {
        ...
        for (var l = this._getItemHandleRect(t, s.handle, Ct), d = Mt, u = null, c = null, f = !0, p = !0, m = 0, g = 0, v = null, y = null, S = 0, w = 0, D = 0, b = null, A = -1 / 0, E = 0, T = 0, x = null, k = 0, L = 0, R = null, I = -1 / 0, C = 0, M = 0, P = null, X = 0, Y = 0, q = 0; q < n.length; q++)
            ...
            p = i && _ && 1 !== u.axis,
            g = u.priority || 0,
            (!f || g < A) && (!p || g < I) || (c = yt(u.element || u),
            w = f ? Dt(c) : -1,
            D = p ? bt(c) : -1,
            (w || D) && ((m = It(l, d = At(c, d))) <= 0 || (f && g >= A && w > 0 && (g > A || m > T) && (y = null,
            v = xt("number" == typeof u.threshold ? u.threshold : o, r, l.width, d.width),
            5 === a ? (S = d.right + v.offset - l.right) <= v.value && St(c) < w && (y = 5) : 9 === a && (S = l.left - (d.left - v.offset)) <= v.value && St(c) > 0 && (y = 9),
            null !== y && (b = c,
            A = g,
            E = v.value,
            T = m,
            ...
            k = S,
            L = w)),
            p && g >= I && D > 0 && (g > I || m > M) && (y = null,
            v = xt("number" == typeof u.threshold ? u.threshold : o, r, l.height, d.height),
            6 === _ ? (S = d.bottom + v.offset - l.bottom) <= v.value && wt(c) < D && (y = 6) : 10 === _ && (S = l.top - (d.top - v.offset)) <= v.value && wt(c) > 0 && (y = 10),
            null !== y && (R = c,
            I = g,
            C = v.value,
            M = m,
            ...
            X = S,
            Y = D)))));
        e && (b ? this._requestItemScroll(t, 1, b, x, E, k, L) : this._cancelItemScroll(t, 1)),
        i && (R ? this._requestItemScroll(t, 2, R, P, C, X, Y) : this._cancelItemScroll(t, 2))
    }
    ,
    Pt.prototype._updateScrollRequest = function(t) {
        for (var e = t.item, i = Et(e), s = dt(i.targets) ? i.targets(e) : i.targets, n = s && s.length || 0, o = i.threshold, r = i.safeZone, h = this._getItemHandleRect(e, i.handle, Ct), a = Mt, _ = null, l = null, d = !1, u = null, c = null, f = null, p = null, m = null, g = 0; g < n; g++)
            if ((l = yt((_ = s[g]).element || _)) === t.element) {
                ...
                if (It(h, a = At(l, a)) <= 0)
                    break;
                if (u = xt("number" == typeof _.threshold ? _.threshold : o, r, d ? h.width : h.height, d ? a.width : a.height),
    ...
    Pt.prototype._updateRequests = function() {
        for (var t, e, i, s, n, o, r, h = this._items, a = this._requests[1], _ = this._requests[2], l = 0; l < h.length; l++)
            ...
            o = !0,
            (e = a[t._id]) && e.isActive && (o = !this._updateScrollRequest(e)) && (n = !0,
            this._cancelItemScroll(t, 1)),
            r = !0,
            (i = _[t._id]) && i.isActive && (r = !this._updateScrollRequest(i)) && (n = !0,
    ...
    Pt.prototype._updateActions = function() {
        var t, e, i, s, n = this._items, o = this._requests, r = this._actions;
    ...
    function oe(t, e) {
        for (e = e || []; t && t !== document; )
            t.getRootNode && t instanceof DocumentFragment ? t = t.getRootNode().host : (ne(t) && e.push(t),
            t = t.parentNode);
    ...
    var ce, fe, pe, me, ge = /^(iPad|iPhone|iPod)/.test(window.navigator.platform) || /^Mac/.test(window.navigator.platform) && window.navigator.maxTouchPoints > 1, ve = !!T() && {
        passive: !0
    };
    function ye(t) {
        var e = t._element
        ...
        this._isDestroyed = !1,
        this._isMigrating = !1,
        this._startPredicate = dt(s.dragStartPredicate) ? s.dragStartPredicate : ye.defaultStartPredicate,
    ...
    ye.defaultStartPredicate = function(t, e, i) {
        ...
        if (e.isFirst && e.srcEvent.button)
            return !1;
        if (!ge && e.isFirst && !0 === e.srcEvent.isTrusted && !1 === e.srcEvent.defaultPrevented && !1 === e.srcEvent.cancelable)
            return !1;
        if (!e.isFinal) {
    ...
    function(t, e) {
        ...
        var _ = function(t, e, i) {
            var s, n, o, r, h, a, _, l, d, u, c = null, f = e._settings.dragSort, p = -1;
            if (!0 === f ? (me[0] = e,
            n = me) : dt(f) && (n = f.call(e, t)),
            !n || !Array.isArray(n) || !n.length)
                return c;
            for (u = 0; u < n.length; u++)
                if (!(o = n[u])._isDestroyed) {
                    for (o._updateBoundingRect(),
                    a = Math.max(0, o._left),
                    _ = Math.max(0, o._top),
                    l = Math.min(window.innerWidth, o._right),
                    d = Math.min(window.innerHeight, o._bottom),
                    r = o._element.parentNode; r && r !== document && r !== document.documentElement && r !== document.body; )
                        if (r.getRootNode && r instanceof DocumentFragment)
                            r = r.getRootNode().host;
                        else {
                            if ("visible" !== ct(r, "overflow") && (h = r.getBoundingClientRect(),
                            a = Math.max(a, h.left),
                            _ = Math.max(_, h.top),
        ...
        if (!_)
            return null;
        var l, d, u, c = t.getGrid() !== _, f = 0, p = 0, m = 0, g = -1, v = !1;
        for (_ === o ? (ce.left = n._gridX + t._marginLeft,
        ce.top = n._gridY + t._marginTop) : (_._updateBorders(1, 0, 1, 0),
        f = _._left + _._borderLeft,
        p = _._top + _._borderTop),
        u = 0; u < _._items.length; u++)
            (l = _._items[u])._isActive && l !== t && (v = !0,
            fe.width = l._width,
            fe.height = l._height,
    ...
    ye.prototype.stop = function() {
        if (this._isActive)
            if (this._isMigrating)
                ...
                var t = this._item
                  , e = t._id;
                if (ye.autoScroller.removeItem(t),
                ot(e),
                rt(e),
                ht(e),
                this._cancelSort(),
                this._isStarted) {
                    ...
                    i.parentNode !== s._element && (s._element.appendChild(i),
    ...
    ye.prototype._bindScrollListeners = function() {
        ...
        if (n.length = 0,
        oe(this._item._element.parentNode, n),
        s !== i)
            for (oe(i, t = []),
            e = 0; e < t.length; e++)
    ...
    ye.prototype._checkHeuristics = function(t, e) {
        ...
        if (r || (this._blockedSortIndex = null),
    ...
    ye.prototype._handleSort = function() {
        if (this._isActive) {
            ...
            if (!t.dragSort || !t.dragAutoScroll.sortDuringScroll && ye.autoScroller.isItemScrolling(this._item))
    ...
    ye.prototype._checkOverlap = function() {
        if (this._isActive) {
            var t, e, n, o, r, h, a, _, l = this._item, m = this._getGrid()._settings;
            (t = dt(m.dragSortPredicate) ? m.dragSortPredicate(l, this._dragMoveEvent) : ye.defaultSortPredicate(l, m.dragSortPredicate)) && "number" == typeof t.index && (a = t.action === i ? i : s,
            _ = (e = l.getGrid()) !== (o = t.grid || e),
            n = e._items.indexOf(l),
            r = Wt(o._items, t.index, _ && a === s ? 1 : 0),
            (_ || r !== this._blockedSortIndex) && (_ ? (this._blockedSortIndex = null,
            h = o._items[r],
            e._hasListeners(c) && e._emit(c, {
                item: l,
                fromGrid: e,
                fromIndex: n,
                toGrid: o,
            ...
            e.layout(),
            o.layout()) : n !== r && (this._blockedSortIndex = n,
            (a === i ? Nt : Bt)(e._items, n, r),
            e._hasListeners(d) && e._emit(d, {
                item: l,
                fromIndex: n,
                toIndex: r,
                action: a
    ...
    ye.prototype._finishMigration = function() {
        var t, e, i = this._item, s = i._dragRelease, n = i._element, o = i._isActive, r = i.getGrid(), h = r._element, a = r._settings, _ = a.dragContainer || h, l = this._getGrid()._settings, d = n.parentNode, u = o ? l.itemVisibleClass : l.itemHiddenClass, c = o ? a.itemVisibleClass : a.itemHiddenClass;
        this._isMigrating = !1,
        this.destroy(),
        l.itemClass !== a.itemClass && (ue(n, l.itemClass),
        Ot(n, a.itemClass)),
        u !== c && (ue(n, u),
        Ot(n, c)),
        _ !== d && (_.appendChild(n),
    ...
    ye.prototype._applyStart = function() {
        if (this._isActive) {
            ...
            if (t._isActive) {
                ...
                o && (i.parentNode === this._container ? (this._gridX -= this._containerDiffX,
    ...
    ye.prototype._onMove = function(t) {
        ...
        it.add(0, z + e, i),
        it.add(2, V + e, s),
        at(n._id, this._handleSort)) : this.stop()
    }
    ,
    ...
    ye.prototype._onEnd = function(t) {
        ...
        s._emit("dragEnd", e, t),
        this._isMigrating ? this._finishMigration() : o.start()) : this.stop()
    }
    ;
    ...
    function be(t) {
        var e = De[t];
        return e || ((e = t.replace(we, "")) !== t && (e = e[0].toLowerCase() + e.slice(1)),
        De[t] = e,
        e)
    }
    function Ae(t, e) {
    ...
    var Ee, Te, xe = !(!Element || !dt(Element.prototype.animate)), ke = !!(Element && (Ee = Element.prototype.animate,
    Te = window.Symbol,
    Ee && dt(Te) && dt(Te.toString) && Te(Ee).toString().indexOf("[native code]") > -1));
    function Le(t) {
        this._element = t,
    ...
    Le.prototype.start = function(t, e, i) {
        if (!this._isDestroyed) {
            ...
            if (!xe)
                ...
                void this._onFinish();
            var o, r, h, a = this._animation, _ = this._props, l = this._values, d = n.duration || 300, u = n.easing || "ease", c = !1;
            if (a && (r = 0,
            d === this._duration && u === this._easing || (c = !0),
            !c)) {
                for (o in e)
                    if (++r,
                    -1 === (h = _.indexOf(o)) || e[o] !== l[h]) {
                        c = !0;
                        break
                    }
                r !== _.length && (c = !0)
    ...
    Ce.prototype._onLayoutStart = function(t, e) {
        ...
        if (-1 !== t.indexOf(i)) {
            ...
            e || this._didMigrate || o !== s || r !== n) {
                var h, a, _, l = s + i._marginLeft, d = n + i._marginTop, u = i.getGrid();
    ...
    Ce.prototype._startAnimation = function() {
        if (this.isActive()) {
            ...
            if (e !== s || i !== n) {
                ...
                t.isAnimating() && (this._element.style[Ft] = Ie(s, n),
                t.stop())
        }
    }
    ,
    ...
    Ce.prototype.create = function() {
        if (this.isActive())
            ...
            var t, e = this._item, i = e.getGrid(), s = i._settings, o = this._animation;
            this._left = e._left,
            this._top = e._top,
            t = dt(s.dragPlaceholder.createElement) ? s.dragPlaceholder.createElement(e) : document.createElement("div"),
            this._element = t,
            o._element = t,
    ...
    Ce.prototype.reset = function() {
        if (this.isActive()) {
            var t, e = this._element, i = this._item, s = i.getGrid(), o = s._settings, r = this._animation;
            this._resetAfterLayout = !1,
            _t(i._id),
            t = i._id,
            it.remove(2, $ + t),
            ...
            this._className && (ue(e, this._className),
            this._className = ""),
        ...
        if (!this._isDestroyed) {
            ...
            if (s.parentNode !== n) {
                if (void 0 === t || void 0 === e) {
                    var r = de(s);
                    t = r.x - this._containerDiffX,
                    e = r.y - this._containerDiffY
                }
                n.appendChild(s),
                i._setTranslate(t, e),
                o = !0
    ...
    Pe.prototype.start = function(t, e) {
        if (!this._isDestroyed) {
            var i, s, n, o = this._item, r = o._dragRelease, h = o.getGrid()._settings, a = this._isActive, _ = r.isJustReleased(), l = _ ? h.dragRelease.duration : h.layoutDuration, d = _ ? h.dragRelease.easing : h.layoutEasing, u = !t && !this._skipNextAnimation && l > 0;
            if (a && (st(o._id),
            o._emitter.burst(this._queue, !0, o)),
    ...
    Xe.prototype.start = function(t, e, i) {
        if (!this._isDestroyed) {
            var s, n, o, r, h, a, _, l, d, m, g = this._item, v = g._element, y = g.isActive(), S = g.isVisible(), w = g.getGrid(), D = w._settings, b = t._settings, A = t._element, E = t._items, T = w._items.indexOf(g), x = i || document.body;
            if ("number" == typeof e)
                s = Wt(E, e, 1);
            else {
                if (!(n = t.getItem(e)))
            ...
            (g.isPositioning() || this._isActive || g.isReleasing()) && (_ = (a = de(v)).x,
            l = a.y),
            g.isPositioning() && g._layout.stop(!0, _, l),
            this._isActive && (_ -= this._containerDiffX,
            l -= this._containerDiffY,
            this.stop(!0, _, l)),
            g.isReleasing() && (_ -= g._dragRelease._containerDiffX,
            l -= g._dragRelease._containerDiffY,
            g._dragRelease.stop(!0, _, l)),
            g._visibility.stop(!0),
            g._drag && g._drag.destroy(),
            w._hasListeners(c) && w._emit(c, {
                item: g,
                fromGrid: w,
                fromIndex: T,
                toGrid: t,
            ...
            D.itemClass !== b.itemClass && (ue(v, D.itemClass),
            Ot(v, b.itemClass)),
            (d = S ? D.itemVisibleClass : D.itemHiddenClass) !== (m = S ? b.itemVisibleClass : b.itemHiddenClass) && (ue(v, d),
            Ot(v, m)),
            w._items.splice(T, 1),
            Gt(E, g, s),
            g._gridId = t._id,
            y ? x !== (o = v.parentNode) && (x.appendChild(v),
            r = ie(x, o, !0),
            a || (_ = (a = de(v)).x,
            l = a.y),
            g._setTranslate(_ + r.left, l + r.top)) : A.appendChild(v),
    ...
    Xe.prototype.stop = function(t, e, i) {
        if (!this._isDestroyed && this._isActive) {
            var s, n = this._item, o = n._element, r = n.getGrid()._element;
            this._container !== r && (void 0 !== e && void 0 !== i || (t ? (e = (s = de(o)).x - this._containerDiffX,
    ...
    Ye.prototype._startAnimation = function(t, e, i) {
        if (!this._isDestroyed) {
            var s, n = this._item, o = this._animation, r = this._childElement, h = n.getGrid()._settings, a = t ? h.visibleStyles : h.hiddenStyles, _ = t ? h.showDuration : h.hideDuration, l = t ? h.showEasing : h.hideEasing, d = e || _ <= 0;
            if (a) {
                if (nt(n._id),
                d)
                    return Ae(r, a),
    ...
    function Ge(t) {
        ...
        if (_.prototype.computeLayout = function(t, e) {
            var i, s, n, o, r, h, _ = t.items, l = t.slots, d = !!(1 & e), u = !!(2 & e), c = !!(4 & e), f = !!(8 & e), p = !!(16 & e), m = "number" == typeof _[0];
            if (!_.length)
                return t;
            for (s = m ? 2 : 1,
            i = 0; i < _.length; i += s)
                m ? (o = _[i],
                r = _[i + 1]) : (o = (n = _[i])._width + n._marginLeft + n._marginRight,
                r = n._height + n._marginTop + n._marginBottom),
                p && (o = a(o),
                r = a(r)),
                h = this.computeNextSlot(t, o, r, d, u),
                u ? h.left + h.width > t.width && (t.width = h.left + h.width) : h.top + h.height > t.height && (t.height = h.top + h.height),
        ...
        _.prototype.computeNextSlot = function(t, e, i, s, n) {
            var o, a, _, l, d, u = this.slotData, c = this.currentRects, f = this.nextRects, p = !1;
            for (f.length = 0,
            u.left = null,
            u.top = null,
            u.width = e,
            u.height = i,
            l = 0; l < c.length; l++)
                if ((a = c[l]) && (o = this.getRect(a),
                u.width <= o.width + r && u.height <= o.height + r)) {
                    u.left = o.left,
                    u.top = o.top;
                    break
                }
            if (null === u.left && (n ? (u.left = t.width,
            u.top = 0) : (u.left = 0,
            u.top = t.height),
            s || (p = !0)),
            !n && u.top + u.height > t.height + r && (u.left > h && f.push(this.addRect(0, t.height, u.left, 1 / 0)),
            u.left + u.width < t.width - h && f.push(this.addRect(u.left + u.width, t.height, t.width - u.left - u.width, 1 / 0)),
            t.height = u.top + u.height),
            n && u.left + u.width > t.width + r && (u.top > h && f.push(this.addRect(t.width, 0, 1 / 0, u.top)),
            u.top + u.height < t.height - h && f.push(this.addRect(t.width, u.top + u.height, 1 / 0, t.height - u.top - u.height)),
            t.width = u.left + u.width),
            !p)
                for (s && (l = 0); l < c.length; l++)
                    if (a = c[l])
                        for (o = this.getRect(a),
                        _ = this.splitRect(o, u),
                        d = 0; d < _.length; d++)
                            a = _[d],
                            o = this.getRect(a),
                            (n ? o.left + r < t.width - r : o.top + r < t.height - r) && f.push(a);
            return f.length > 1 && this.purgeRects(f).sort(n ? this.sortRectsLeftTop : this.sortRectsTopLeft),
            this.currentRects = f,
            this.nextRects = c,
            u
        }
        ...
        ,
        _.prototype.splitRect = (e = [],
        i = 0,
        s = 0,
        function(t, n) {
            return e.length = 0,
            t.left + t.width <= n.left + r || n.left + n.width <= t.left + r || t.top + t.height <= n.top + r || n.top + n.height <= t.top + r ? (e.push(this.addRect(t.left, t.top, t.width, t.height)),
            e) : ((i = n.left - t.left) >= h && e.push(this.addRect(t.left, t.top, i, t.height)),
            (i = t.left + t.width - (n.left + n.width)) >= h && e.push(this.addRect(n.left + n.width, t.top, i, t.height)),
            (s = n.top - t.top) >= h && e.push(this.addRect(t.left, t.top, t.width, s)),
            (s = t.top + t.height - (n.top + n.height)) >= h && e.push(this.addRect(t.left, n.top + n.height, t.width, s)),
            e)
        }
        ),
            ...
            for (var e, i = t.length; i--; )
                ...
                t[i])
                    for (this.getRect(t[i], n); e--; )
                        if (t[e] && i !== e && (this.getRect(t[e], o),
                        this.isRectAWithinRectB(n, o))) {
                            t[i] = 0;
                            break
                        }
            return t
        ...
        _.prototype.sortRectsTopLeft = function() {
            ...
            return function(i, s) {
                ...
                this.getRect(s, e),
                t.top < e.top && t.top + r < e.top ? -1 : t.top > e.top && t.top - r > e.top ? 1 : t.left < e.left && t.left + r < e.left ? -1 : t.left > e.left && t.left - r > e.left ? 1 : 0
            }
        }(),
        _.prototype.sortRectsLeftTop = function() {
            ...
            return function(i, s) {
                return this.getRect(i, t),
                this.getRect(s, e),
                t.left < e.left && t.left + r < e.left ? -1 : t.left > e.left && t.left - r < e.left ? 1 : t.top < e.top && t.top + r < e.top ? -1 : t.top > e.top && t.top - r > e.top ? 1 : 0
            }
        }(),
        t) {
            var l = new _;
    ...
    Fe.prototype.destroy = function() {
        ...
        !function(t) {
            ...
            Be && !Ne.length && (URL.revokeObjectURL(Be),
            Be = null)
        }(this._workers),
    ...
    function Ze() {}
    var Je, $e = "number", Ke = "string", ti = "instant", ei = 0;
    function ii(e, i) {
        if (typeof e === Ke && (e = document.querySelector(e)),
    ...
    function si(t, e) {
        var i, s, n, o = Object.keys(e), r = o.length;
        for (n = 0; n < r; n++)
            i = Ue(e[s = o[n]]),
            Ue(t[s]) && i ? t[s] = si(si({}, t[s]), e[s]) : i ? t[s] = si({}, e[s]) : Array.isArray(e[s]) ? t[s] = e[s].slice(0) : t[s] = e[s];
        return t
    }
    function ni(t) {
    ...
    ii.prototype.refreshItems = function(t, e) {
        ...
        if (!0 === e)
            for (o = [],
            i = 0; i < r.length; i++)
                (s = r[i]).isVisible() || s.isHiding() || ((n = s.getElement().style).visibility = "hidden",
                n.display = "",
                o.push(n));
    ...
    ii.prototype.layout = function(t, e) {
        ...
        var h, a = this._width - this._borderLeft - this._borderRight, _ = this._height - this._borderTop - this._borderBottom, l = this._settings.layout;
        return dt(l) ? h = l(this, s, o, a, _, this._onLayoutDataReceived) : (ii.defaultPacker.setOptions(l),
        h = ii.defaultPacker.createLayout(this, s, o, a, _, this._onLayoutDataReceived)),
        dt(h) && this._nextLayoutData && this._nextLayoutData.id === s && (this._nextLayoutData.cancel = h),
        this
    }
    ,
    ii.prototype.add = function(t, e) {
        ...
        if (!s.length)
            return s;
        var n, o, r, h, a = e || {}, _ = a.layout ? a.layout : void 0 === a.layout, l = this._items, d = !1;
        for (h = 0; h < s.length; h++)
            (o = s[h]).parentNode !== this._element && (n = n || document.createDocumentFragment()).appendChild(o);
        for (n && this._element.appendChild(n),
        h = 0; h < s.length; h++)
            o = s[h],
            (r = s[h] = new He(this,o,a.active))._isActive && (d = !0,
            r._layout._skipNextAnimation = !0);
        for (h = 0; h < s.length; h++)
            (r = s[h])._refreshDimensions(),
            r._refreshSortData();
        return Gt(l, s, a.index),
    ...
    ii.prototype.remove = function(t, e) {
        if (this._isDestroyed || !t.length)
            return [];
        var i, s, n, o = e || {}, r = o.layout ? o.layout : void 0 === o.layout, a = !1, _ = this.getItems(), l = [], d = [];
        for (n = 0; n < t.length; n++)
            (s = t[n])._isDestroyed || -1 !== (i = this._items.indexOf(s)) && (s._isActive && (a = !0),
            l.push(s),
            d.push(_.indexOf(s)),
            s._destroy(o.removeElements),
            this._items.splice(i, 1));
        return this._hasListeners(h) && this._emit(h, l.slice(0), d),
    ...
    ii.prototype.filter = function(t, e) {
        if (this._isDestroyed || !this._items.length)
            return this;
        var i, s, n = [], o = [], r = typeof t === Ke, h = dt(t), a = e || {}, l = !0 === a.instant, d = a.syncWithLayout, u = a.layout ? a.layout : void 0 === a.layout, c = dt(a.onFinish) ? a.onFinish : null, f = -1, p = Ze;
        if (c && (p = function() {
        ...
        o.length ? this.hide(o, {
            instant: l,
            syncWithLayout: d,
            onFinish: p,
            layout: !1
        }) : p(),
        (n.length || o.length) && (this._hasListeners(_) && this._emit(_, n.slice(0), o.slice(0)),
    ...
    ii.prototype.sort = function() {
        ...
        function n(n, o) {
            for (var r, h, a, _, l = 0, d = 0; d < t.length; d++)
                ...
                l = "desc" === h || !h && e ? _ < a ? -1 : _ > a ? 1 : 0 : a < _ ? -1 : a > _ ? 1 : 0)
                    return l;
            return l || (s || (s = oi(i)),
            l = e ? ri(s, o, n) : ri(s, n, o)),
            l
        }
        function o(n, o) {
            var r = e ? -t(n, o) : t(n, o);
            return r || (s || (s = oi(i)),
            r = e ? ri(s, o, n) : ri(s, n, o)),
            r
        }
        return function(r, h) {
            ...
            dt(r))
                ...
                t = r.trim().split(" ").filter((function(t) {
                    return t
                }
                )).map((function(t) {
                    return t.split(":")
            ...
            return this._hasListeners(l) && this._emit(l, a.slice(0), i),
    ...
    ii.prototype.move = function(t, e, n) {
        if (this._isDestroyed || this._items.length < 2)
            return this;
        var o, r, h = this._items, a = n || {}, _ = a.layout ? a.layout : void 0 === a.layout, l = a.action === i, u = l ? i : s, c = this.getItem(t), f = this.getItem(e);
        return c && f && c !== f && (o = h.indexOf(c),
        r = h.indexOf(f),
        l ? Nt(h, o, r) : Bt(h, o, r),
        this._hasListeners(d) && this._emit(d, {
            item: c,
            fromIndex: o,
            toIndex: r,
            action: u
    ...
    ii.prototype.send = function(t, e, i, s) {
        ...
        return t._migrate.start(e, i, o),
        t._migrate._isActive && t._isActive && (r && this.layout(r === ti, dt(r) ? r : void 0),
    ...
    ii.prototype.destroy = function(e) {
        if (this._isDestroyed)
            return this;
        var i, s, n, o = this._element, r = this._items.slice(0), h = this._layout && this._layout.styles || {};
    ...
    ,
    ii.prototype._onLayoutDataReceived = (Je = [],
    function(t) {
        if (!this._isDestroyed && this._nextLayoutData && this._nextLayoutData.id === t.id) {
            var e, i, s, h, a = this, _ = this._nextLayoutData.instant, l = this._nextLayoutData.onFinish, d = t.items.length, u = d;
            for (this._nextLayoutData = null,
            !this._isLayoutFinished && this._hasListeners(r) && this._emit(r, this._layout.items.slice(0)),
            this._layout = t,
            Je.length = 0,
            h = 0; h < d; h++)
                (e = t.items[h]) ? (i = t.slots[2 * h],
                s = t.slots[2 * h + 1],
                e._canSkipLayout(i, s) ? --u : (e._left = i,
                e._top = s,
                e.isActive() && !e.isDragging() ? Je.push(e) : --u)) : --u;
            if (t.styles && Ae(this._element, t.styles),
            !this._hasListeners(n) || (this._emit(n, t.items.slice(0), !0 === _),
            this._layout.id === t.id)) {
                ...
                h = 0; h < Je.length && this._layout.id === t.id; h++)
                    Je[h]._layout.start(!0 === _, c);
                return this._layout.id === t.id && (Je.length = 0),
                this
            }
        }
    }
    ...
    ii.prototype._setItemsVisibility = function(t, e, i) {
        var s, o, r = this, h = t.slice(0), _ = i || {}, l = !0 === _.instant, d = _.onFinish, u = _.layout ? _.layout : void 0 === _.layout, c = h.length, f = e ? "showStart" : a, p = e ? "showEnd" : "hideEnd", m = e ? "show" : "hide", g = !1, v = [], y = [];
        if (c) {
            ...
            y.length && (this.refreshItems(y, !0),
            y.length = 0),
